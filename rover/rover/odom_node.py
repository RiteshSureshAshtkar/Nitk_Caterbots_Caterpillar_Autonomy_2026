...
class OdomNode(Node):
    ...
    def publish_odom(self):
        """Publish odometry at fixed 10Hz rate."""
        current_time = self.get_clock().now()
